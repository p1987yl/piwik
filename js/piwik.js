...
/*</DEBUG>*/
                ...
                configSessionCookieTimeout = 86400000, // 30(1800000) minutes change to 1 day 
            ...
            function getRequest(request, customData, pluginMethod, currentEcommerceOrderTs) {
                ...
                '&send_image=0' + '&_custom_session_id=' + encodeWrapper(getCookie(getCookieName('custom_session_id')));
                // browser features
            ...
            function logEcommerce(orderId, grandTotal, subTotal, tax, shipping, discount) {
                ...
                if (isEcommerceOrder) {
                    ...
                    lastEcommerceOrderTs = Math.round(now.getTime());
                }
...
/*</DEBUG>*/
                ...
                setCookieValue: function (cookieNamePrefix, cookieValue) {
                    var CookieName = getCookieName(cookieNamePrefix);
                    setCookie(CookieName, cookieValue, getRemainingVisitorCookieTimeout(), configCookiePath, configCookieDomain);
                },
